...
// ---------------------------------------------------------------------------
// Hasura entry points (POST /hasura-cron, /hasura-webhooks)
// ---------------------------------------------------------------------------
...
// swaggerHasuraWebhooks godoc
// @Summary      Legacy Hasura event-trigger sink (no-op)
// @Description  All event triggers have been migrated to PostgreSQL triggers and application code. This endpoint logs+200s any stale webhook deliveries to avoid retries.
// @Tags         hasura
// @Accept       json
// @Produce      json
// @Param        payload body map[string]interface{} true "Hasura event-trigger payload"
// @Success      200 {object} HealthResponse
// @Failure      400 {object} HasuraActionError
// @Security     ActionToken
// @Router       /hasura-webhooks [post]
func swaggerHasuraWebhooks() {}
