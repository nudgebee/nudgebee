...
// PopeyeRuleName is the recommendation.rule_name written by ParsePopeye.
// Kept as a top-level const (not read from ScannerCatalog) to avoid a
// package-init cycle: ScannerCatalog wires ParsePopeye, ParsePopeye would
// otherwise read back from the catalog.
const PopeyeRuleName = "popeye_misconfigurations"
