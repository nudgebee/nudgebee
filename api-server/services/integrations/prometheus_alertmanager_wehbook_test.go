...
func TestTools_GetCreatePrometheusAlertManagerWebhookToolConfigs(t *testing.T) {
	...
	config, err := core.CreateIntegrationConfig(sc, "", IntegrationPrometheusAlertManagerWebhook, toolConfigName, []core.IntegrationConfigValue{
		{
			Name:  "token",
			Value: "2b98da823bb43de0e30a6f0bcd2a5f285fec87e95d3872b6109643ddab1303a1a30627d0",
		},
	},
		map[string]any{
			"env": "dev",
	...
	err = core.ProcessEventWebook(sc, "https://dev.nudgebee.pollux.in/api/webhooks/prometheus-alertmanager?token=2b98da823bb43de0e30a6f0bcd2a5f285fec87e95d3872b6109643ddab1303a1a30627d0", map[string]string{}, prometheusAlertManagerWebhookPayload)
	assert.Nil(t, err)
