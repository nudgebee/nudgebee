...
- For database set environment variable `export HASURA_ACTIONS_DB_URL=postgresql://<username>:<password>@localhost:5432/nudgebee?sslmode=disable` and port forward `kubectl --namespace nudgebee port-forward svc/pg-main-proxy-service 5432:5432`
