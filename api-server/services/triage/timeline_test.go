					...
					"updated_values": [
						{
							...
							"old": "registry.nudgebee.com/services:2025-12-08T05-52-46_5105d5a",
							"new": "registry.nudgebee.com/services:2025-12-08T08-22-55_2179cc3"
						}
					]
				}
			}]`,
...
func TestExtractImageTag(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "full image URL",
			input:    "registry.nudgebee.com/services:2025-12-08T05-52-46_5105d5a",
