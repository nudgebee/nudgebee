...
func lowercaseResourceIndex(lookup *sources.NodeLookup) map[string]*core.DbNode {
...
func (s *AzureSource) createReferenceEdges(resources []sources.CloudResourceRow, lookup *sources.NodeLookup, req *core.SourceBuildRequest) []*core.DbEdge {
...
func vmssByResourceGroup(lookup *sources.NodeLookup) map[string][]*core.DbNode {
...
func (s *AzureSource) createAppReferenceEdges(resources []sources.CloudResourceRow, lookup *sources.NodeLookup, req *core.SourceBuildRequest) []*core.DbEdge {
...
//     resource directly.
func (s *AzureSource) buildPrincipalIndex(resources []sources.CloudResourceRow, arnIndex map[string]*core.DbNode) map[string]*core.DbNode {
	idx := make(map[string]*core.DbNode)
	for i := range resources {
		r := &resources[i]
...
// access path.
func (s *AzureSource) createRoleAssignmentEdges(resources []sources.CloudResourceRow, lookup *sources.NodeLookup, req *core.SourceBuildRequest) []*core.DbEdge {
	edges := make([]*core.DbEdge, 0)
	arnIndex := lowercaseResourceIndex(lookup)
