...
// Azure all-types NODE-coverage completeness (Tier A). Moved here from package
// sources because it reads the unexported Azure registry maps. Small test helpers
