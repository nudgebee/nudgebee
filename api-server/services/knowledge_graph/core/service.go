...
const (
	EdgeBatchSize = 5000 // 12 columns × 5000 = 60,000 params (under 65,535 limit)
	NodeBatchSize = 5000 // 12 columns × 5000 = 60,000 params (under 65,535 limit)
)
...
func (s *Service) SaveEdges(edges []*DbEdge, nodes []*DbNode, syncVersion int64) error {
	...
	cols := []string{"id", "created_at", "updated_at", "source_node_id", "destination_node_id", "relationship_type", "properties", "cloud_account_id", "tenant_id", "level", "is_active", "last_sync_version"}
...
func (s *Service) SaveNodes(nodes []*DbNode, syncVersion int64) error {
	...
	// Prepare data for bulk insert
	cols := []string{"id", "created_at", "updated_at", "properties", "labels", "query_attributes", "cloud_account_id", "tenant_id", "unique_key", "node_type", "level", "last_sync_version", "is_active", "source"}
