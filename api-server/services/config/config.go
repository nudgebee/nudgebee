...
type appConfig struct {
	...
	ServiceDBUrl                    string `mapstructure:"hasura_actions_db_url"`
	ServiceDBMaxConnection          int    `mapstructure:"hasura_actions_db_max_connection"`
	ServiceDBMinConnection          int    `mapstructure:"hasura_actions_db_min_connection"`
	ServiceDBIdleMinutes            int    `mapstructure:"hasura_actions_db_idle_minutes"`
	ServiceDBConnMaxLifetimeMinutes int    `mapstructure:"hasura_actions_db_conn_max_lifetime_minutes"`
...
func init() {
	...
	viper.SetDefault("hasura_actions_db_url", "")
	viper.SetDefault("hasura_actions_db_max_connection", "20")
	viper.SetDefault("hasura_actions_db_min_connection", "2")
	viper.SetDefault("hasura_actions_db_idle_minutes", "5")
	viper.SetDefault("hasura_actions_db_conn_max_lifetime_minutes", "5")
