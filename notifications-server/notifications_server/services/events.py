...
from notifications_server.utils.base_util import (
...
class Events:
    ...
    def update_llm_chat_feedback(self, payload, channel_id, team_id, thread_ts):
        try:
            ...
            execute_and_get_result(HASURA_CREATE_AI_FEEDBACK, feedback_object)
    ...
    def call_event_analysis_api(event_id, account_id, user_id, tenant_id):
        try:
            ...
            headers = {"x-tenant-id": tenant_id, "x-user-id": user_id, "Content-Type": "application/json"}
