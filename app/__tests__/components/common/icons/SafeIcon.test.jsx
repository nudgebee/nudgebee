...
jest.mock('next/image', () => ({
  __esModule: true,
  // Destructure Next.js-specific props so they are not forwarded to the DOM <img>.
  // Spreading them causes React "non-boolean attribute" / "unknown prop" warnings.
  default: ({ src, alt, unoptimized: _u, onError: _e, fill: _f, ...props }) =>
    React.createElement('img', { src: typeof src === 'object' ? src?.src ?? '' : src, alt, 'data-testid': 'next-image', ...props }),
}));
