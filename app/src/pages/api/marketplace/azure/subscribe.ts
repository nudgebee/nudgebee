 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/marketplace/azure/subscribe instead.
 *
 * Azure marketplace callback shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/marketplace/azure/subscribe';

export default createDeprecatedShim(handler, '/api/integrations/marketplace/azure/subscribe');
