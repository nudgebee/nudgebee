 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/marketplace/azure/webhook instead.
 *
 * Azure marketplace webhook shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/marketplace/azure/webhook';

export default createDeprecatedShim(handler, '/api/integrations/marketplace/azure/webhook');
