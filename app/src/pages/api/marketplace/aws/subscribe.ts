 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/marketplace/aws/subscribe instead.
 *
 * AWS marketplace callback shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/marketplace/aws/subscribe';

export default createDeprecatedShim(handler, '/api/integrations/marketplace/aws/subscribe');
