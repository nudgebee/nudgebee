    ...
    >
      <Box sx={{ minHeight: ds.space.mul(0, 100), pt: ds.space[5], pb: ds.space[2] }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: ds.space[5] }}>
          ...
          {/* Token Field */}
          <Box sx={{ mb: ds.space[1] }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: ds.space[2], pl: ds.space[1] }}>
              <Typography
                variant='body2'
                sx={{
                  color: ds.gray[400],
              ...
              {isEdit && (
                <Tooltip title='Stored token will be used if left unchanged'>
                  <Box sx={{ ml: ds.space[2], cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
