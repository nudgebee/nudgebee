...
const ThreeDotsLoader = ({ size = 4, color, sx }) => (
  <Box
    sx={{
      display: 'inline-flex',
      alignItems: 'center',
      ...
      '& > span': {
        ...
        animation: 'three-dots-pulse 1.2s infinite ease-in-out both',
      },
        ...
        return (
          ...
          >
            ...
            {isPending && isSubmitting ? (
              <ThreeDotsLoader size={4} color={colors.primary} sx={{ flexShrink: 0, mr: '2px' }} />
            ) : (
              <ArrowForwardIcon
                sx={{
                  fontSize: '12px',
