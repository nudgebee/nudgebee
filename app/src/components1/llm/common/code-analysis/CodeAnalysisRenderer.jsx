...
const extractRepoMeta = (sourceDetails) => {
  ...
  const repo = sourceDetails['workloads.nudgebee.com/git.repo'] || sourceDetails.git_repo || sourceDetails.repo;
  const hash = sourceDetails['workloads.nudgebee.com/git.hash'] || sourceDetails.git_hash || sourceDetails.commit;
  return {
