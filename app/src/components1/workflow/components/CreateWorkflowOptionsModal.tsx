...
interface CreateWorkflowOptionsModalProps {
  ...
  onUseTemplate: () => void;
  onAskAI: () => void;
  onCreateFromJson: () => void;
  onCreateFromYaml: () => void;
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '36%', px: '8px', gap: '4px' }}>
            ...
            />
            <Text
              value='Paste an automation JSON definition to create'
              sx={{
                fontSize: '13px',
                fontWeight: 400,
                lineHeight: '16px',
        ...
        >
          ...
          >
            <DescriptionOutlinedIcon sx={{ fontSize: '120px', color: '#0EA5E9' }} />
          </Box>
          <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '36%', px: '8px', gap: '4px' }}>
            <Text
              value='Create from YAML'
              sx={{
                fontSize: '16px',
                fontWeight: 600,
              }}
            />
            <Text
              value='Paste an automation YAML definition to create'
              sx={{
                fontSize: '13px',
                fontWeight: 400,
                lineHeight: '16px',
