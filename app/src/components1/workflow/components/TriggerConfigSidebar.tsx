...
const EVENT_PAYLOAD_DOCS_URL = 'https://docs.nudgebee.com/docs/features/workflow-builder/#event-payload-schema';

const buildFilterExpression = (currentValues: Record<string, string>, overrides?: Record<string, string>): string => {
...
const parseFilterExpression = (filter: string): Record<string, string> => {
