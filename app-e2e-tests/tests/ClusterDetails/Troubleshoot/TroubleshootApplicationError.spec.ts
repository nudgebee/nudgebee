...
test("Graphql testing Cluster Details->Troubleshoot-> Applications Errors", { tag: ["@dev", "@test", "@oss", "@smoke", "@functional"] }, async ({ page }, testInfo) => {
  ...
  await waitForGraphQLAndValidate(
    page,
    async () => {
      await locators.clickTab(locators.TroubleshootApplicationErrors);
    },
    {
