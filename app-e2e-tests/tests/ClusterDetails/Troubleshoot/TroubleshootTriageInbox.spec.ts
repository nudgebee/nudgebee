...
test("Graphql testing Cluster Details->Troubleshoot-> Triage Inbox", { tag: ["@dev", "@test", "@oss", "@smoke", "@functional"] }, async ({ page }, testInfo) => {
  ...
  await waitForGraphQLAndValidate(
    page,
    async () => {
      await locators.clickTab(locators.TroubleshootTriageInbox);
    },
    {
