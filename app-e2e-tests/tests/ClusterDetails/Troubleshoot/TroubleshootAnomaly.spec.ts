...
test("Graphql testing Cluster Details->Troubleshoot-> Anomaly", { tag: ["@dev", "@test", "@oss", "@smoke", "@functional"] }, async ({ page }, testInfo) => {
  ...
  await waitForGraphQLAndValidate(
    page,
    async () => {
      await locators.clickTab(locators.TroubleshootAnomaly);
    },
    {
