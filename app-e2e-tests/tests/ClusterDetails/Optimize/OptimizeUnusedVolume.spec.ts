...
test("Graphql testing Cluster Details->Optimize-> Unused Volumes", { tag: ["@dev", "@test", "@oss", "@smoke", "@functional"] }, async ({ page }, testInfo) => {
  ...
  await waitForGraphQLAndValidate(
    page,
    async () => {
      await locators.gotoOptimizeSection(OptimizeSections.unusedVolume);
    },
