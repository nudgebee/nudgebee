...
func TestSync_LiteModel_FixedBySyncModelWithContextOverrides(t *testing.T) {
	...
	provider, model := syncModelWithContextOverrides(ctx, "googleai", fullModel, accountId)
...
func TestSync_LiteModel_NoContextKey(t *testing.T) {
	...
	provider, model := syncModelWithContextOverrides(ctx, "googleai", fullModel, "acc")
...
func TestSync_QueryConfigOverride_FixedBySyncModelWithContextOverrides(t *testing.T) {
	...
	provider, model := syncModelWithContextOverrides(ctx, "googleai", configModel, accountId)
...
func TestSync_ModelOverride_TakesPriorityOverLiteModel(t *testing.T) {
	...
	provider, model := syncModelWithContextOverrides(ctx, "googleai", configModel, "acc")
...
func TestSync_FallbackPathNotAffected(t *testing.T) {
	...
	provider, model := syncModelWithContextOverrides(ctx, "googleai", "gemini-3-pro-preview", "acc")
