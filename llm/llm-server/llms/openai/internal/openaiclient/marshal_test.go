...
func TestIsReasoningModel(t *testing.T) {
	tests := []struct {
		...
		// NUDGEBEE: cases the original prefix/suffix matching got wrong.
		{"o1", true},                   // bare o1 — bare o3 was handled, o1 was not
		{"o1-2024-12-17", true},        // dated checkpoint
		{"openai/o1", true},            // namespaced, as a gateway serves it
		{"openai/o3-mini", true},       // namespaced + suffixed
		{"openai/gpt-5.6-terra", true}, // our own custom-provider id format
		{"gpt-4o-mini", false},         // the 'o' here must not trigger the o-series match
		{"o1x-experimental", false},    // o1 must be followed by a hyphen or end of string
		{"claude-o1-lookalike", false}, // o1 mid-identifier is not the o-series

		// NUDGEBEE: aligned with reasoningFamilyRx in the parent package — the two
		// matchers must not diverge, which is how o4/o5 went unrecognised here.
		{"o4-mini", true},
		{"openai/o4-mini", true},
		{"openai/o5", true},
		{"azure:gpt-5", true},
