...
func TestSanitizeErrorMessage(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input:    `Post "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:streamGenerateContent?%24alt=json&key=EXAMPLE-NOT-A-REAL-API-KEY-do-not-use": context canceled`,
