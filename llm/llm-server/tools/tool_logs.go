...
func (t *NBLogTool) Call(nbRequestContext core.NbToolContext, input core.NBToolCallRequest) (core.NBToolResponse, error) {
	...
	case "loki":
		...
		return core.NBToolResponse{
			...
			Status:     core.NBToolResponseStatusSuccess,
			References: []core.NBToolResponseReference{core.GetNudgebeeUIReferenceForClusterDetails(nbRequestContext, []string{"monitoring", "query-logs"}, "Query Logs", nil, logsQuery)},
		}, nil
	...
	case "es", "elasticsearch":
		...
		return core.NBToolResponse{
			...
			Type:       core.NBToolResponseTypeJson,
			Status:     core.NBToolResponseStatusSuccess,
			References: []core.NBToolResponseReference{core.GetNudgebeeUIReferenceForClusterDetails(nbRequestContext, []string{"monitoring", "query-logs"}, "Query Logs", nil, esDSL)},
		}, nil
	...
	case "signoz":
		...
		return core.NBToolResponse{
			...
			Type:       core.NBToolResponseTypeJson,
			Status:     core.NBToolResponseStatusSuccess,
			References: []core.NBToolResponseReference{core.GetNudgebeeUIReferenceForClusterDetails(nbRequestContext, []string{"monitoring", "query-logs"}, "Query Logs", nil, string(filtersJSON))},
		}, nil
	...
	case "loggly", "observ", "observe":
		...
		return core.NBToolResponse{
			...
			Type:       core.NBToolResponseTypeJson,
			Status:     core.NBToolResponseStatusSuccess,
			References: []core.NBToolResponseReference{core.GetNudgebeeUIReferenceForClusterDetails(nbRequestContext, []string{"monitoring", "query-logs"}, "Query Logs", nil, logQuery)},
		}, nil
	}
