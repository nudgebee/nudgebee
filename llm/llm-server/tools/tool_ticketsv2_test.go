...
func TestInferTicketPlatformFromQuery(t *testing.T) {
	cases := []struct {
		...
		{"all supported platforms recognized — gitlab", "show gitlab tickets", "gitlab"},
		{"all supported platforms recognized — servicenow", "servicenow incidents", "servicenow"},
		{"all supported platforms recognized — zenduty", "zenduty alerts", "zenduty"},
		{"all supported platforms recognized — freshdesk", "freshdesk tickets", "freshdesk"},
		{"all supported platforms recognized — incidentio", "incidentio tickets", "incidentio"},
		// Nobody types the integration type "incidentio" in a question; the
		// product is spelled "incident.io", so that spelling must infer too.
		{"incident.io dotted spelling infers", "open an incident.io incident", "incidentio"},
		{"incident.io mixed case dotted spelling infers", "list Incident.IO incidents", "incidentio"},
		{"bare word 'incident' does NOT infer a platform", "create an incident for this alert", ""},
