...
from benchmark_server.config import setup_logger, get_log_config_path
from benchmark_server.utils.db_utils import init_db
from benchmark_server.utils.utils import set_global_trace
...
controllers_dir = os.path.join(
    os.path.dirname(__file__), "benchmark_server", "controllers"
)
