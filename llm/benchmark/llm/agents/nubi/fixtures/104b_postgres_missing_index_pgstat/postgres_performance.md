...
```bash
kubectl run temp-psql --image=postgres:15-alpine --rm -it --restart=Never --namespace=namespace-104b --env="PGPASSWORD=example-fake-password" -- psql -h postgres -U postgres -d userdb
```
