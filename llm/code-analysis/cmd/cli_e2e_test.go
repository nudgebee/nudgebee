...
// testLogs is a representative error payload used by the live CLI analysis
// tests below. It only matters for the e2e flow, so it lives in this file.
...
// TestCLIOutputFormat tests that CLI produces valid JSON output
