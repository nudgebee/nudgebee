...
func TestServiceMapApplication_MarshalJSON(t *testing.T) {
	app := ServiceMapApplication{
		Id: ServiceApplicationId{
			Name:      "arn:aws:elasticloadbalancing:us-east-1:740395098545:loadbalancer/app/Demo-Frontend-ALB/9ef0c75b824fa80c",
			Kind:      "elbv2",
			Namespace: "us-east-1",
		},
	...
	expectedName := "arn:aws:elasticloadbalancing:us-east-1:740395098545:loadbalancer/app/Demo-Frontend-ALB/9ef0c75b824fa80c"
