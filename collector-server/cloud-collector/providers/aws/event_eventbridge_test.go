...
func (d *dummyAwsProvider) ListResources(ctx providers.CloudProviderContext, account providers.Account, query providers.ListResourceRequest) (providers.ListResourcesResponse, error) {
	...
	if query.ServiceName == "ecs" {
		return providers.ListResourcesResponse{Items: []providers.Resource{{
			Id:          "abcdef1234567890",
			Arn:         "arn:aws:ecs:us-east-1:864186153326:task/my-cluster/abcdef1234567890",
			...
			Meta: map[string]any{
				"taskDefinitionArn": "arn:aws:ecs:us-east-1:864186153326:task-definition/my-app-task-def:1",
				"lastStatus":        "STOPPED",
			},
		}}}, nil
	}
	if query.ServiceName == "ecr" {
		return providers.ListResourcesResponse{Items: []providers.Resource{{
			...
			Arn:         "arn:aws:ecr:us-east-1:864186153326:repository/nudgebee_runbook_sidecar_agent",
...
func TestAwsEvenBridge_Mock_ECS(t *testing.T) {
	sqsMessageBody := `{
		...
		"region": "us-east-1",
		"resources": [
			"arn:aws:ecs:us-east-1:864186153326:task/my-cluster/abcdef1234567890"
		],
		"detail": {
			"clusterArn": "arn:aws:ecs:us-east-1:864186153326:cluster/my-cluster",
			"taskArn": "arn:aws:ecs:us-east-1:864186153326:task/my-cluster/abcdef1234567890",
			"taskDefinitionArn": "arn:aws:ecs:us-east-1:864186153326:task-definition/my-app-task-def:1",
			"lastStatus": "STOPPED",
			...
			"containers": [
				{
					"containerArn": "arn:aws:ecs:us-east-1:864186153326:container/my-cluster/abcdef1234567890/container-id-1",
					"taskArn": "arn:aws:ecs:us-east-1:864186153326:task/my-cluster/abcdef1234567890",
	...
	assert.Contains(t, processedEvent.Description, "ECS Task arn:aws:ecs:us-east-1:864186153326:task/my-cluster/abcdef1234567890")
...
func TestAwsEventBridge_RDS_TagChange(t *testing.T) {
	sqsMessageBody := `{
		...
		"detail": {
			...
			"awsRegion": "us-east-1",
			"requestParameters": {
				"resourceName": "arn:aws:rds:us-east-1:864186153326:db:database-1-instance-1",
				"tags": [
...
func TestAwsEventBridge_ECS_CloudTrail_DeleteService(t *testing.T) {
	sqsMessageBody := `{
		...
		"detail": {
			...
			"awsRegion": "us-east-1",
			"requestParameters": {
				"service": "arn:aws:ecs:us-east-1:864186153326:service/my-cluster/my-service",
				"cluster": "my-cluster"
			},
			"userIdentity": {
				"type": "IAMUser",
